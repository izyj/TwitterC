...
public class UpdateStatusView extends  Scene {

	FXMLLoader loader;

	public UpdateStatusView(Parent arg0) {
		super(arg0);
	...
	try {
        ...
        loader.setLocation(getClass().getResource("/com/twit4life/view/UpdateStatusView.fxml"));
